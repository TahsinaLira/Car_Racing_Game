...
o	Create a database 
o	Import the SQL file (if provided)
6.	Update database credentials in the code:
7.	String url = "jdbc:mysql://localhost:3306/database_name";
8.	String user = "root";
9.	String password = "your_password";
10.	Run the main file: Main.java


 <img width="268" height="188" alt="menu_bg" src="https://github.com/user-attachments/assets/a1165003-faac-401e-b99e-e497e0262759" />

<img width="200" height="200" alt="cross_road" src="https://github.com/user-attachments/assets/c2d5577c-b521-4805-bb9d-60221e7bbc04" />
